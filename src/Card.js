          ...
          <div className="delete-modal">
            ...
            <div className="delete-btn-container">
              ...
              <button
                ...
                onClick={() =>
                  props.handleDelete(props.id, props.isReply, props.parentId)
                }
              >
                Yes, delete
              </button>
        ...
        <div className="comment-section">
          <div className="comment-score">
            <FontAwesomeIcon
              ...
              onClick={() =>
                props.handleUpvote(props.id, props.isReply, props.parentId)
              }
            />
            ...
            <FontAwesomeIcon
              ...
              size="m"
              alt="Downvote"
              className="downvote action"
              onClick={() =>
                props.handleDownvote(props.id, props.isReply, props.parentId)
              }
            />
          </div>
          ...
          <div className="comment-user-info">
            ...
            {props.currentUser.username === props.user.username && (
              <p className="self-tag">you</p>
            )}
            <p className="comment-time">recently added</p>
          </div>
        ...
        {isReplying && (
          <div className="replying-section">
            ...
            <textarea
              ...
              onChange={handleReplyingTextValueChange}
            />
            <button
